                ...
                <>
                    <div className="relative w-full group">
                        ...
                        <div className={inputSingleFileVariants({ size })}>
                            <Icon className={inputSingleFileIconVariants()} svg={UploadFileIcon} />
                    ...
                    <div className="flex flex-col gap-1 mt-1">
                        ...
                        {error && (
                            <Text variant="label-medium" className="text-accent-red mt-1 block">
                                {error}
                            </Text>
                        )}
